...
import (
	...
	"github.com/cyrinux/monitor2call/api"
)
...
func init() {
	...
	db.Create(&api.Users{Name: "Pierre", Email: "p@example.com", Phone: "+3312345678"})
	db.Create(&api.Users{Name: "Paul", Phone: "+3412345679"})
	db.Create(&api.Users{Name: "Jacques", Email: "j@example.com"})
